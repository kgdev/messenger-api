# Messenger OpenAPI Specification
[![Build Status](https://travis-ci.org/kgdev/messenger-api.svg?branch=master)](https://travis-ci.org/kgdev/messenger-api)
...
6. If you did everything correct, https://kgdev.github.io/messenger-api/ will lead to your new docs
...
- Documentation(ReDoc): https://kgdev.github.io/messenger-api/
- SwaggerUI: https://kgdev.github.io/messenger-api/swagger-ui/
- Look full spec:
    + JSON https://kgdev.github.io/messenger-api/swagger.json
    + YAML https://kgdev.github.io/messenger-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://kgdev.github.io/messenger-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://kgdev.github.io/messenger-api/ with url from the message: `Server started <url>`
